...
>Break down a prediction to show the impact of each feature for an individual prediction.

(vs. extracting general insights from a machine learning model as before)
...
An example is helpful, and we'll continue the soccer/football example from the permutation importance and partial dependence plots lessons.In these tutorials, we predicted whether a team would have a player win the Man of the Match award.
...
<img src=https://i.imgur.com/JVD2U7k.png alt=shap>
...
```
![Partial Plot](img/shap.png "2D Partial Plot")
